...
public class FindPrimeFactor {
	...
	public static int findPrimeFactor(List<Integer> a, List<Integer> b) {
		...
		// looping array 'b' because array 'a' can be longer than 'b'
		// once it's found return the value and exit out.
	...
	private static boolean isPrime(Integer n) {
		// prime number can't be negative and 0 and 1 are not prime number
		if (n <= 1) {
			return false;
		}
		for (int i = 2; i < n; i++) {
